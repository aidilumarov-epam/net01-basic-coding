...
namespace BasicCoding.Tests
{
    ...
    public class BasicCodingTests
    {
        ...
        {
            var finder = new RecursiveMaxElementFinder();
            return finder.FindMaxElement(sourceArray);
        }
        ...
        {
            var finder = new IndexOfElementBetweenEqualSumsFinder();
            return finder.FindIndex_Optimized(sourceArray);
        }
        ...
        public int CheckNearestLargerNumber(int number)
        {
            var finder = new NearestLargerNumberFinder();
            return finder.FindNearestLargerNumber(number);
        }
        ...
        public int[] CheckDigitFiltering(int[] sourceArray, int digit)
        {
            ...
            return filterer.Filter(sourceArray, digit);
        }
    }
}